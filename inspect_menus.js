...
(async () => {
    ...
    try {
        ...
        await page.goto('https://www.infohas.ma/wp-admin/admin.php?page=avada_options#menu_options', { waitUntil: 'domcontentloaded', timeout: 120000 });
        await page.waitForTimeout(5000);
        await page.screenshot({ path: 'avada_menu_options.png', fullPage: true });

        console.log('Checking UberMenu Configuration...');
        await page.goto('https://www.infohas.ma/wp-admin/themes.php?page=ubermenu-settings', { waitUntil: 'domcontentloaded' });
        await page.waitForTimeout(5000);
        await page.screenshot({ path: 'ubermenu_settings.png', fullPage: true });
