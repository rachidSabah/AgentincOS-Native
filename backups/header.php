...
?>
	...
	<link href="<?=get_stylesheet_directory_uri();?>/assets/carousel/css/owl.carousel.css" rel="stylesheet">
	<link href="<?=get_stylesheet_directory_uri();?>/assets/carousel/css/owl.theme.css" rel="stylesheet">
	<link href="<?=get_stylesheet_directory_uri();?>/assets/carousel/css/owl.transitions.css" rel="stylesheet">	
</head>
<?php
$wrapper_class = '';
